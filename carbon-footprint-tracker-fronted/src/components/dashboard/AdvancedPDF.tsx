...
const AdvancedPDF:React.FC=()=>{
  ...
  const getSuggestion=()=>{
    ...
    if(score>=60) 
      return "Good performance. Maintain efficient driving habits and reduce unnecessary trips.";
    if(score>=40) 
      return "Moderate emissions. Consider carpooling or optimizing daily travel routes.";
    return "High emissions. Reduce fuel consumption by maintaining speed and vehicle efficiency.";
  };
    ...
    <>
      ...
      >
        ...
        <p style={{ fontSize:"10px",marginTop:"10px",color:"gray"}}>
          This report is generated based on your vehicle carbon emission analytics.
        </p>
      </div>
    </>
  );
