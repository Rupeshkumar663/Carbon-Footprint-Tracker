...
const RouteTrack:React.FC<StatCardProps>=({ value })=>{
  return (
    <motion.div
      ...
      whileHover={{ y: -3 }}
      className="relative px-24 py-3 rounded-2xl text-center bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.65)] transition-all duration-500 overflow-hidden">
        ...
        <p className="relative text-gray-300 font-semibold text-2xl mb-3 tracking-wide">Route Tracked</p>
        <h2 className=" relative text-white text-5xl font-bold tracking-wide drop-shadow-[0_0_6px_rgba(255,255,255,0.6)]"
        style={{ textShadow: "0 0 4px rgba(255,255,255,0.6), 0 0 10px rgba(255,255,255,0.4)"}}>{value}</h2>
    </motion.div>
  );
};
