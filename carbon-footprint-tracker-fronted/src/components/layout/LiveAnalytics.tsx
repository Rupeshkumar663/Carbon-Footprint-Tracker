     ...
     <section className="bg-black text-white py-16 sm:py-24 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-[-1px] md:tracking-[-2px]">Unified Carbon Intelligence</h2>
          <p className="mt-5 text-gray-400 text-lg">
           Real-time emissions monitoring across vehicles, flights, and fighter jets.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
          <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0B0B0B] p-6 sm:p-10 hover:border-green-500/30 sm:hover:-translate-y-2 transition-all duration-500">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0B0B0B] p-6 sm:p-10 hover:border-cyan-500/30 sm:hover:-translate-y-2 transition-all duration-500">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0B0B0B] p-6 sm:p-10 hover:border-orange-500/30 sm:hover:-translate-y-2 transition-all duration-500">
