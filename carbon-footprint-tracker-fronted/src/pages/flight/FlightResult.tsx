    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        ...
        <div className="w-full max-w-3xl bg-[#0d0d0d]/80 backdrop-blur-xl border border-green-500/20 rounded-3xl p-8 shadow-[0_0_80px_rgba(34,197,94,0.25)] transition-all duration-500">
          ...
          {/* 🌍 Heading */}
          <h1 className="text-3xl text-center text-green-400 font-semibold mb-8">
          ...
          <div className="grid grid-cols-2 gap-6 bg-black/40 p-6 rounded-2xl border border-green-500/10">
            ...
            <div>
              ...
              <p className="text-lg font-semibold">{state.from}</p>
            </div>

            <div>
              <p className="text-gray-400 text-sm">To</p>
              <p className="text-lg font-semibold">{state.to}</p>
            </div>

            <div>
              <p className="text-gray-400 text-sm">Distance</p>
              <p>{state.distance} km</p>
            </div>
            ...
            <div>
              <p className="text-gray-400 text-sm">Seat Class</p>
              <p>{seatClass}</p>
            </div>

            <div>
              <p className="text-gray-400 text-sm">Per Passenger</p>
              <p>{state.perPassenger} kg CO₂</p>
            </div>
          ...
          <div className="text-center mt-8">
            ...
            <h2 className="text-5xl text-green-400 font-bold mt-2 drop-shadow-[0_0_15px_rgba(34,197,94,0.8)]">
              {state.totalCO2} kg CO₂
            </h2>
          </div>
          ...
          <div className="flex justify-center gap-4 mt-8">
            ...
            <button
              onClick={() => navigate(-1)}
              className="px-6 py-2 border border-green-500/30 rounded-xl hover:bg-green-500/10"
            >
              Back
            </button>
            ...
            <button
              onClick={() => navigate("/")}
              className="px-6 py-2 bg-green-500 text-black rounded-xl hover:scale-105 transition"
            >
              New
            </button>
