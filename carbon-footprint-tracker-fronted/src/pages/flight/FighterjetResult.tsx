    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-3xl bg-[#0d0d0d]/80 backdrop-blur-xl border border-green-500/20 rounded-3xl p-8 shadow-[0_0_80px_rgba(34,197,94,0.25)] transition-all duration-500">
          <h1 className="text-2xl sm:text-3xl text-center text-green-400 font-semibold mb-8">Carbon Footprint Result</h1>
         <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-6 bg-black/40 p-8 rounded-2xl border border-green-500/10">
         ...
         <div className="text-center">
          ...
          <div className="text-center mt-8">
            ...
            <h2 className="text-3xl sm:text-5xl text-green-500 font-bold mt-2 drop-shadow-[0_0_15px_rgba(34,197,94,0.8)]">{data?.totalCO2} kg CO₂</h2>
          </div>
          ...
          <div className="mt-10">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                ...
                {data.ecoScore> 70 ? "Eco Friendly 🌱":data.ecoScore> 40 ? "Moderate ⚠️":"High Emission"}
              </span>
            </div>
